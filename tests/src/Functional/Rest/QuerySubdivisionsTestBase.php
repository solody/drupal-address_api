...
/**
 * Test for QuerySubdivisions rest resource.
 *
 * @coversDefaultClass \Drupal\address_api\Plugin\rest\resource\QuerySubdivisions
 */
abstract class QuerySubdivisionsTestBase extends ResourceTestBase {
   ...
   * {@inheritdoc}
   */
  protected static $resourceConfigId = 'address_api_query_subdivisions';
